...
<template>
  <div class="margin-top-20">
    <textarea :id="id" name="content" v-model="outContent" :uploadJson="fileUpload" :allowFileManager="true"></textarea>
  </div>
</template>
<script>
...
export default {
  ...
  data () {
    return {
      ...
      // fileUpload: config.fileUrl,
      fileUpload: config.fileUrl2 ,//文件上传路径
    }
  },
  props: {
    content: {
