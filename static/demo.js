...
$(function () {
	...
	// 初始化插件参数及插入插件
	WebVideoCtrl.I_InitPlugin(450, 300, {
...
// 		var szIP = element.DeviceInfo.IP
// 		console.log("szIP:" + szIP);
// 		if (szIP == "10.20.105.234") {
// 			szIP = "192.168.12.15"
// 		}
// 		if ("" == szIP || "" == szPort) {
// 			return;
// 		}
// 		console.log("szIP2:" + szIP);
...
// // 开始预览
// function clickStartRealPlay(array) {
...
function mouseDownPTZControl(iPTZIndex) {
	...
	if (oWndInfo != null) {
		console.log("iPTZIndex:" + iPTZIndex);
		console.log("g_bPTZAuto:" + g_bPTZAuto);
